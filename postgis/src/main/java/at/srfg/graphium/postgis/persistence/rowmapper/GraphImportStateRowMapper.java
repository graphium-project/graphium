...
public class GraphImportStateRowMapper implements RowMapper<IGraphImportState> {

	@Override
	public IGraphImportState mapRow(ResultSet rs, int rowNum) throws SQLException {
		return new GraphImportState(
