 ...
 */
public abstract class AbstractConnectionXInfo implements IConnectionXInfo {

    private String xInfoType;
    private String groupKey;

    public AbstractConnectionXInfo(String xInfoType) {
        this.xInfoType = xInfoType;
    }

    public AbstractConnectionXInfo(String xInfoType, String groupKey) {
        this.xInfoType = xInfoType;
