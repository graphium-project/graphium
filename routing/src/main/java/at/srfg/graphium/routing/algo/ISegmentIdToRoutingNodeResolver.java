 ...
 */
public interface ISegmentIdToRoutingNodeResolver<N> {
	 ...
	 * 
	 * @param segmentId the graphium segment's ID
	 ...
	 */
	public N resolveSegment(Long segmentId, String graphName, String graphVersion);
}
