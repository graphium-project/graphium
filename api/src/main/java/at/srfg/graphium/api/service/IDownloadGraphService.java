 ...
 * @author mwimmer
 */
public interface IDownloadGraphService {
	
	/**
	 * @param importInfoList List of <code>GraphVersionsImportInfo</code> containing info about graph version to download and import
