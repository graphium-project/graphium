...
import at.srfg.graphium.io.dto.impl.SubscriptionDTOImpl;
import at.srfg.graphium.model.management.ISubscription;

/**
 * @author mwimmer
 */
public class Subscription2SubscriptionDTOAdapter implements IAdapter<ISubscriptionDTO, ISubscription> {

	@Override
	public ISubscriptionDTO adapt(ISubscription subscription) {
		ISubscriptionDTO subscriptionDTO = new SubscriptionDTOImpl(
